...
<form action="${var}" method="POST">
    ...
    <c:if test="${!empty product.name}">
        ...
        <input type="text" name="alternative_name" id="alternative_name" value="${product.alternative_name}">
        <label for="brandName">Brand name</label>
        <input type="text" name="brandName" id="brandName" value="${product.brandName}">
        ...
        <input type="text" name="quantityInStore" id="quantityInStore" value="${product.quantityInStore}">
    </c:if>
