...
public interface ClientService {
    ...
    List<OrderDTO> getOrderListByClientId(int clientId, int page);

    String checkExistingEmailsThenAddAnotherOneAndReturnStatus(ClientDTO clientDTO);

    String addClientAndReturnUniqEmailStatus(ClientDTO clientDTO);
}
